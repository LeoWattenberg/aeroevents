...
Status: undersøgt 13.-14. september 2026 og fjerde integrationsrunde afsluttet
...
| 6 | [Ærø Folkedanserforening](https://6165826142842.site123.me/) | Server-renderede eventkort med stabilt `data-unique-id` og nummererede detail-URL'er. Der var 24 kommende familie- og voksenarrangementer frem til marts 2027. Siden gengiver eventsektionen to gange. | Det entydigt nummererede voksenforløb samles som én afgrænset ugegentagelse med ferieuger som `EXDATE`. Familieholdet bevares enkeltvis, fordi en forekomst mangler sluttid. Metadataafvigelser stopper sammenlægningen. |
...
| 13 | [Campus Ærø](https://campusaeroe.dk/events/) | The Events Calendars offentlige [REST-endpoint](https://campusaeroe.dk/wp-json/tribe/events/v1/events) gav 196 fremtidige forekomster med pagination, numerisk ID, start/slut, ændringstid, status, venue, kategori, stabil slug og datomærket permalink. Kalenderen blander offentlige kultur-, sundheds- og værkstedsarrangementer med undervisning og lukkede skole-/personaleforløb. | De 169 poster, hvor kategori `campus-ugentlig`, slug og permalink er enige, samles tabsfrit i seks afgrænsede ugegentagelser med ferieuger som `EXDATE`. Modstrid mellem brødtekst og strukturerede felter sendes til gennemsyn; øvrige allowlistede poster forbliver enkeltstående. |
...
fire kilder Ærø Bridgeklub, Aktivitetshuset OvenPaa, Ærø Svømmeklub og Marstal
Marineforening blev tilføjet i fjerde runde. De øvrige rækker forbliver
dokumenteret backlog og aktiveres først, når en konkret kommende post kan
valideres sikkert.

| Kilde | Teknisk vej | Redaktionel regel |
| --- | --- | --- |
| [Ommel Samvirkes aktivitetskalender](https://www.ommelsamvirke.dk/aktivitetskalender) | Den anonyme Blazor-kalender viste 292 forekomster i 16 aktiviteter fra 14. september 2026 til 13. september 2027. Den samler otte lokale foreninger og har blandt andet gåture, gymnastik, dart, strik, petanque, IT-hjælp, fredagsbar, fællesspisning og møder. Detaljedialogen har tid, sted, kategori, beskrivelse, arrangør og kontakt. | Automatisk for komplette poster fra den ensartede detaljedialog. Når beskrivelsen selv angiver en ugentlig eller 14-dages regel, gemmes den som en afgrænset gentagelse; et rent datomønster er ikke tilstrækkeligt. Manglende sted eller beskrivelse samt pris, tilmelding eller status, der kun står i fritekst, sendes til gennemsyn. Det offentlige [`calendar.ics`](https://www.ommelsamvirke.dk/calendar.ics) er defekt og bruges ikke. |
...
| [Ærø Bridgeklub](https://www.bridge.dk/4596/Turneringsoversigt.html) | BridgeCentral-siden har en aktuel 2026/27-plan. Livekontrollen gav seks afgrænsede ugentlige serier og ni enkeltdatoer; de navngivne mandagsturneringer bevares særskilt, og en tur til Langeland blev udeladt. | Implementeret til gennemsyn. Sammenhængende blokke gemmes som `RRULE`, mens onsdagsplanens feriehuller bliver eksplicitte `EXDATE`. Sæson og semantisk bloknavn er identitet; gæstepris og tilmeldingsfrist bevares. |
| [Aktivitetshuset OvenPaa](https://ahop.dk/) | Syv allowlistede WordPress-sider angiver dart, tre strikke-/håndarbejdsaktiviteter samt keramik-, væve- og træværksted med faste ugedage. | Implementeret til gennemsyn som syv ugentlige regler. WordPress-side-ID er identitet. En titel/brødtekst-konflikt og alle manglende sluttider markeres; et teknisk `DTSTART` mærkes `startDateUnknown`. |
| [Ærø Svømmeklub](https://aero.klub-modul.dk/cms/TeamOverviewProgramList.aspx) | KlubModuls program og holdplan gav 18 sæsonafgrænsede hold med stabile `TeamID`, tid, start/slut, alder, pris og tilmeldingsstatus. | Implementeret til gennemsyn som 18 ugentlige regler. Kun konsistente lukkedage bliver `EXDATE`; modstridende ferieprosa bevares som advarsel. Instruktør- og deltageroplysninger gemmes ikke. |
| [Marstal Marineforening](https://www.marstalmarineforening.dk/aktiviteter/) | Den aktuelle prosaside gav en ugentlig søndagsserie og fem lokale enkeltdatoer. En Skagen-tur, poster med »dato følger« og en aktivitetsblok uden synligt præcist tidspunkt blev udeladt. | Implementeret til gennemsyn. Søndagsseriens oplyste slutdato bliver `UNTIL`, mens den manglende første dato markeres med `startDateUnknown`; medlemsadgang og ukendte adgangsvilkår bevares. |
...
| [Marstal Sejl- og Roklub](https://marstalsejlogroklub.dk/kalendar/) | Det offentlige [årsprogram 2026](https://marstalsejlogroklub.dk/wp-content/uploads/2026/04/Arsprogram-20260411.pdf) har eksplicitte datoer for aftenkapsejlads, klubweekender, oprydning, standerstrygning og julefrokost samt enkelte tekstlige ugeregler. | Næste adapter bør læse PDF'en atomisk, bruge `år+sektion+titel` som identitet og kun danne gentagelser af de eksplicit oplistede datoer. Uklare tidspunkter, adgang og »programsættes senere« skal til gennemsyn eller udelades. |
...
| [Ærø Club for Hundeejere](https://aech.dk/hvalpe-hold) | Holdsiden angiver indskrivning, træningsstart og antal træninger; de øvrige holdsider linker til billedbaserede sæsonplaner med mange eksplicitte datoer. Tekst og billeder er ikke altid indbyrdes konsistente. | Gennemsyn eller manuel sæsonimport, indtil en billedparser kan kontrollere hele datolisten atomisk. Brug `hold+sæson` som serieidentitet, bevar vaccinations-/forsikringskrav, og gæt ikke en ubrudt ugeregel. |
...
| [Marstal IF Gymnastik](https://www.marstalif.dk/gymnastik/holdoversigt-i-gymnastik-afdelingen/) | Den aktuelle 2026/27-side beskriver ti ugentlige børne-, unge-, motions- og seniorhold med tid og sted; kun enkelte hold har en eksplicit første dato, og ingen har en sikker slutdato eller ferieplan. | Næste HTML-adapter kan bruge sæson og strukturelt holdnavn som ID og `startDateUnknown` for manglende første dato. Alle regler skal til gennemsyn, og træner-/kontaktoplysninger skal ikke gemmes. |
| [Ærø Kommune: Aktivt seniorliv](https://www.aeroekommune.dk/mit-liv/aeldre/aktivt-seniorliv-2) | Den kommunale emneportal linker til mere end 20 aktivitetsbeskrivelser; flere undersider har faste ugedage, tid, sted og målgruppe, blandt andet OK-klubbens torsdagstræf. | Byg først en flerside-adapter med stabile CMS-side-ID'er, klar allowlist og overlapkontrol mod Ældre Sagen og foreningernes direkte kilder. Sæsonløse aktiviteter skal bruge teknisk `DTSTART` og altid til gennemsyn. |
